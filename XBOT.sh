...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source XBOT - اهلا بك في سورس اكس ~"
...
wget "api-XBOT.tk/installubuntu18/compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
...
echo -e "▀▀▀░ ▀▀▀ ░░▀░░     ▀░░░▀ ▀░░▀ ▀░▀▀ ░░▀░░ ▀▀▀ ▀░░▀"
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (MARTEN) @marten_vs_worled.|"
echo -e "|   This Is The Source Channel @SRCX_B0T .     |"
echo -e "|                - XBOT -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
