...
send_msg(msg.chat_id_, msg.id_, 1, '⌯︙جلب رابط المجموعه معطل', 1, 'md') 
return false  
end
...
send_msg(msg.chat_id_, msg.id_, 1, '⌯︙لايوجد رابط ارسل ↫ ضع رابط او ارسل ↫ انشاء رابط للانشاء', 1, 'md')
end  
end      
end,nil)
end
...
--     Source -𝐗-     --
if text == "المطورين" and ChCheck(msg) or text == "↫ المطوريين  ⌯" and ChCheck(msg) then 
...
send_msg(msg.chat_id_, msg.id_, 1, '⌯︙جاري تحديث سورس اكس', 1, 'md') 
os.execute('rm -rf XBOT.lua') 
os.execute('wget https://raw.githubusercontent.com/gackmm/testo/main/XBOT.lua') 
dofile('XBOT.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
send_msg(msg.chat_id_, msg.id_, 1, '⌯︙تم التحديث الى الاصدار الجديد', 1, 'md') 
end
if text == 'تحديث' or text == 'تحديث البوت' or text == '↫ تحديث ⌯' then  
dofile('XBOT.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n        ( تم تحديث ملفات البوت )        \n\27[0;34;49m\n") 
send_msg(msg.chat_id_, msg.id_, 1, "⌯︙تم تحديث ملفات البوت", 1, "md")
end 
--     Source -𝐗-     --
